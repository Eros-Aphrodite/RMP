          ...
          <CardContent className="p-8 md:p-12">
            ...
            <div className="prose prose-invert max-w-none space-y-6 text-gray-300 leading-relaxed">
              ...
              <div className="border-l-4 border-orange-500 pl-4 my-6">
                <p className="text-white font-semibold mb-2">We at Retail Marketing Pro (the "Business" "we" or "us" in this Privacy Policy)</p>
                <p>
              ...
              <section className="space-y-4">
                <h2 className="text-2xl font-bold text-white mt-8 mb-4">General Notice</h2>
                <p>
              ...
              <section className="space-y-4">
                <h2 className="text-2xl font-bold text-white mt-8 mb-4">Copyrights Notice</h2>
                <p>
              ...
              <section className="space-y-4">
                <h2 className="text-2xl font-bold text-white mt-8 mb-4">Hyper-Links Notice</h2>
                <p>
