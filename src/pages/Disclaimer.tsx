            ...
            <div className="prose prose-invert max-w-none space-y-6 text-gray-300 leading-relaxed">
              <section className="space-y-4">
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li>RMP is a business management tool only</li>
                  <li>We do not guarantee financial, legal, or business outcomes</li>
                  <li>Users are responsible for data, inventory, and business decisions</li>
                  <li>Mobile app stores offline data locally until synced</li>
                  <li>Web app stores data on secure cloud servers</li>
                  <li>Service may be interrupted due to maintenance, updates, or third-party issues</li>
                </ul>
              </section>

              <section className="space-y-4 mt-8">
                <p className="text-lg">
                  <strong className="text-white">Maximum liability: INR 100</strong>
                </p>
              </section>
            </div>
          </CardContent>
